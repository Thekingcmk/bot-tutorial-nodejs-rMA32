...
function respond() {
  ...
  if(request.text && botRegex.test(request.text)) {
    ...
    postMessage("http://daddyleagues.com/KM17/team/"+request.text.substring(5,8)+"/depthchart");
    this.res.end();
  } 
  
  else if(request.text && botRegexOW.test(request.text)) {
    this.res.writeHead(200);
    postMessage("www.daddyleagues.com/KM17/");
    this.res.end();
  } 
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/document/d/1Q5Q7wExFSw8iwiqa8CMm0Q0Rl29MEjMVkAJFydR-Zx0/edit?usp=sharing");
    this.res.end();
  } 
    ...
    postMessage("http://daddyleagues.com/KM17/team/"+request.text.substring(5,8)+"/schedule");
    this.res.end();
  }
    ...
    var rep = req.replace(/ /,"+");
    postMessage("http://daddyleagues.com/KM17/players?name="+rep+"&position=all&team=all");
    ...
    this.res.writeHead(200);
    postMessage("https://docs.google.com/spreadsheets/d/1jzPXDX7hntUJvv75zQjDGp0l20A1Hrxw4XT-hr9Lm80/edit?usp=sharing");
    this.res.end();
  } 
